...
const COLOR_CONFIG = {
  ...
  brand:   { bg: '#0190f6', text: '#ffffff', label: 'Brand'   },
      ...
      <div style={{ flex: 1, minWidth: 0, padding: '48px 56px 96px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 24 }}>
          {[
            ...
            { color: 'brand',   desc: 'Brand blue. Use to tie the count to a primary brand action (e.g., cart, inbox).' },
