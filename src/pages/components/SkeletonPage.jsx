...
import { SectionAnchor, H2, Lead, P, Code, DoBox, DontBox } from '../../components/ComponentPagePrims.jsx'
  ...
  return (
    <div style={{ display: 'flex', gap: 0, alignItems: 'flex-start', maxWidth: 1200, margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: 32 }}>
        ...
        <h1 style={{ fontSize: 36, fontWeight: 800, letterSpacing: '-.6px', color: 'var(--text-primary)', margin: '0 0 16px' }}>Skeleton</h1>
        <Lead>
